...
@ Laboratorio no.12 
@ Seccion: 1011
@ Descripcion: Aqui se realizan las Subrutinas que se necesitan en el programa. En nuestro caso unicamente haremos una. Ya que el programa 
@ necesita una formula que realice el porcenaje de una nota 
@----------------------------------------------------------
@ *************************************************************
...
@Retorna:
@  r0: resultado
@  r1: numero por el cual se calculara el porcenaje 
@ *************************************************************
